...
/**
  * Adapted from caseapp.cats.IOCaseApp. Same shape as the helper used in
  * org.renci.materializer; kept verbatim so that any future fixes can be
  * propagated between the two projects without translation.
  */
